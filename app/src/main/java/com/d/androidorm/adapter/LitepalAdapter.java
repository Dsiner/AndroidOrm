 ...
 */
public class LitepalAdapter extends OrmAdapter<Book> {
    private EditRow etrRow;

    public LitepalAdapter(Context context, List<Book> datas, MultiItemTypeSupport<Book> multiItemTypeSupport) {
