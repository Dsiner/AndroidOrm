 ...
 */
public class GreenDaoAdapter extends OrmAdapter<Book> {
    private EditRow etrRow;

    public GreenDaoAdapter(Context context, List<Book> datas, MultiItemTypeSupport<Book> multiItemTypeSupport) {
