 ...
 */
public class RealmAdapter extends OrmAdapter<Book> {
    private EditRow etrRow;

    public RealmAdapter(Context context, List<Book> datas, MultiItemTypeSupport<Book> multiItemTypeSupport) {
            ...
            case R.layout.adapter_orm_edit:
                ...
                etrRow.setOnTextChangedListener(new EditRow.OnTextChangedListener() {
                    ...
                    public void afterTextChanged(final String... s) {
                        AppDBUtil.getInstance(mContext).optBook()
                        ...
                        AppDBUtil.getInstance(mContext).optBook().update(item);
                    }
                });
                break;
        }
