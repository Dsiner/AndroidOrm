 ...
 */
public class OrmliteAdapter extends OrmAdapter<Book> {
    private EditRow etrRow;

    public OrmliteAdapter(Context context, List<Book> datas, MultiItemTypeSupport<Book> multiItemTypeSupport) {
