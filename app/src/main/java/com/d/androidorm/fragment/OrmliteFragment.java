...
import com.d.androidorm.adapter.OrmliteAdapter;
import com.d.androidorm.presenter.OrmPresenter;
import com.d.androidorm.presenter.OrmlitePresenter;
import com.d.androidorm.view.IOrmliteView;
 ...
 */
public class OrmliteFragment extends OrmFragment<Book> implements IOrmliteView {

    @Override
    protected CommonAdapter<Book> getAdapter() {
        final OrmliteAdapter adapter = new OrmliteAdapter(mContext, new ArrayList<Book>(), new MultiItemTypeSupport<Book>() {
            @Override
    ...
    public OrmPresenter<Book> getPresenter() {
        return new OrmlitePresenter(getActivity().getApplicationContext());
    }
    ...
    protected void init() {
        ...
        ovOperate.setOnCallback(new OperateView.OnCallback() {
            ...
            @Override
            public void insert() {
                OrmliteAdapter ormliteAdapter = (OrmliteAdapter) mAdapter;
                EditRow etrRow = ormliteAdapter.getEtrRow();
