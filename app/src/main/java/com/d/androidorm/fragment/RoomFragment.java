...
import com.d.androidorm.adapter.RoomAdapter;
import com.d.androidorm.presenter.OrmPresenter;
import com.d.androidorm.presenter.RoomPresenter;
import com.d.androidorm.view.IRoomView;
 ...
 */
public class RoomFragment extends OrmFragment<Book> implements IRoomView {

    @Override
    protected CommonAdapter<Book> getAdapter() {
        final RoomAdapter adapter = new RoomAdapter(mContext, new ArrayList<Book>(), new MultiItemTypeSupport<Book>() {
            @Override
    ...
    public OrmPresenter<Book> getPresenter() {
        return new RoomPresenter(getActivity().getApplicationContext());
    }
    ...
    protected void init() {
        ...
        ovOperate.setOnCallback(new OperateView.OnCallback() {
            ...
            @Override
            public void insert() {
                RoomAdapter roomAdapter = (RoomAdapter) mAdapter;
                EditRow etrRow = roomAdapter.getEtrRow();
